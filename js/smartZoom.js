/*  Change log: 
 *      duration default from 700 to 200;
 *      mouseWheelDeltaFactor from 1.5 to 0.05 (line 122);
 */
...
(function( $ ){
  ...
  $.fn.smartZoom = function(method) {
	...
	/**
	 * define public methods that user could call 
	 */
    var publicMethods = {
    	/**
	    ...
	    init : function(options) {
		    ...
		    targetElement.data('smartZoomData', {
               ...
               mouseWheelDeltaFactor:0.05, // enable to slow down the zoom via mouse wheel
	   ...
	   /**
		  ...
		  * @param {Number} duration : zoom effect duration 200ms by default
		  */
	    zoom : function(scaleToAdd, globalRequestedPosition, duration){
			...
			if(duration == null) // default effect duration is 200ms
				duration = 200;
		  ...
		  * @param {Number} duration : move effect duration 200ms by default
		  */
	    pan : function(xToAdd, yToAdd, duration){
	    	if(xToAdd == null || yToAdd == null) // check params
	    		return;
	    		
	    	if(duration == null) // default pan duration is 200ms
				duration = 200;
